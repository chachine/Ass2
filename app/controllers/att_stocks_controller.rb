class AttStocksController < ApplicationController
  before_action :set_att_stock, only: [:show, :edit, :update, :destroy]

  # GET /att_atocks
  # GET /att_atocks.json
  def index
    @att_atocks = AttStock.all
  end
...
#       params.require(:att_atock).permit(:typeV, :numero, :used)
#     end
 end
