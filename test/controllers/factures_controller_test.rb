...
class FacturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create facture" do
    assert_difference('Facture.count') do
      post factures_url, params: { facture: { montant: @facture.montant, montant_recu: @facture.montant_recu } }
    end
  ...
  test "should update facture" do
    patch facture_url(@facture), params: { facture: { montant: @facture.montant, montant_recu: @facture.montant_recu } }
